...
const PROJECT_DOCUMENTATION: OngoingProjectDocumentation = {
  ...
  'family-pool': [
    ...
    { id: 2, title: 'Login — Retro Theme', url: '/images/family-pool/theme-login-retro.png', description: 'A full retro theme, pure CSS on shared component slots' },
    { id: 3, title: 'Rooms Dashboard', url: '/images/family-pool/rooms-list.png', description: "Rooms you're in, what you owe, and pending approvals" },
    { id: 4, title: 'Rooms Dashboard — Retro', url: '/images/family-pool/rooms-list-retro.png', description: 'Rooms dashboard in the retro theme' },
    { id: 5, title: 'Room — Pools Tab', url: '/images/family-pool/room-pools-tab.png', description: 'The pools a family shares inside a room' },
    { id: 6, title: 'Room — Pools Tab — Retro', url: '/images/family-pool/room-pools-tab-retro.png', description: 'Pools tab in the retro theme' },
    { id: 7, title: 'Create Pool Dialog', url: '/images/family-pool/create-pool-dialog.png', description: 'Choose between a cost-split pool or a rotating arisan pot' },
    { id: 8, title: 'Create Pool Dialog — Retro', url: '/images/family-pool/create-pool-dialog-retro.png', description: 'Create-pool dialog in the retro theme' },
    { id: 9, title: 'Room — Members Tab', url: '/images/family-pool/room-members-tab.png', description: 'Manage who is in the room' },
    { id: 10, title: 'Room — Members Tab — Retro', url: '/images/family-pool/room-members-tab-retro.png', description: 'Members tab in the retro theme' },
    { id: 11, title: 'Room — Settings Tab', url: '/images/family-pool/room-settings-tab.png', description: "The room's reusable invite link" },
    { id: 12, title: 'Room — Settings Tab — Retro', url: '/images/family-pool/room-settings-tab-retro.png', description: 'Settings tab in the retro theme' },
    { id: 13, title: 'Cost-Split Pool', url: '/images/family-pool/pool-cost-split.png', description: 'Balance and paid-through period computed live from an append-only ledger' },
    { id: 14, title: 'Cost-Split Pool — Retro', url: '/images/family-pool/theme-pool-retro.png', description: 'Cost-split pool in the retro theme' },
    { id: 15, title: 'Arisan Pool', url: '/images/family-pool/pool-arisan.png', description: 'Rotating savings pot — one random winner per round' },
    { id: 16, title: 'Arisan Pool — Retro', url: '/images/family-pool/pool-arisan-retro.png', description: 'Arisan pool in the retro theme' },
    { id: 17, title: 'Approval Inbox', url: '/images/family-pool/inbox.png', description: "Every room you own's pending receipt approvals in one place" },
    { id: 18, title: 'Approval Inbox — Retro', url: '/images/family-pool/inbox-retro.png', description: 'Approval inbox in the retro theme' },
    { id: 19, title: 'Mobile View', url: '/images/family-pool/mobile-pool.png', description: 'Built mobile-first for uploading receipt photos' },
    { id: 20, title: 'Mobile View — Retro', url: '/images/family-pool/mobile-pool-retro.png', description: 'Mobile view in the retro theme' },
  ],
  marketplace: [
